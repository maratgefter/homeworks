...
class AutoGo extends Tic_Tac_Toe 
    {
        ...
        function computer_make_muve()
        {
            if ($this->put_cross($this->array) != "") {
                return $this->put_cross($this->array);
            } else ($this->put_circle($this->array) != "") {
                return $this->put_circle($this->array);
            }
        }
    }